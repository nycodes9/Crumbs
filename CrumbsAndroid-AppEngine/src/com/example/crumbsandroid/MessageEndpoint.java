 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "example.com", ownerName = "example.com", packagePath="crumbsandroid"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "TODO test api key";
